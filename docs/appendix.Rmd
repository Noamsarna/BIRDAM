...
```{r figure-within-quest-analysis-H2023, include = TRUE, echo=FALSE, fig.cap="Figure A3 Within-Questionnaire Relationship of Item Skewness and Item-Confidence Correlations in Hoven et al. (2023). The same conventions in Figure A1 are used.",fig.lp = ""}
...
```{r skewness-confidence-unfiltered-plot, fig.cap="Figure A4 Correlation between item-level skewness and confidence with extreme skewed items included. Same conventions as Figure 5."}
...
```{r skewness-weights-unfiltered-plot, include = TRUE, echo=FALSE, fig.cap="Figure A5 The Effect of Reversed Items and Skewness on the CIT and AD Dimensions with Extreme Skewed Items included. Same conventions as Figure 6 are used."}
...
```{r sex_differences_inatten, echo=FALSE, fig.cap="Figure A11 – Sex differences in inattentiveness prevalence. "}
...
# Save the figure
ggsave("../figures/oci_permutation.png", oci_permutation_figure, width = 8, height = 6, dpi = 300)  
